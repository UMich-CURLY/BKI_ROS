...
class LatLonHeading {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LatLonHeading(null);
  ...
  static datatype() {
    ...
    return 'scene_understanding/LatLonHeading';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '00947911068f3157ed193e902dabb90f';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LatLonHeading(null);
