// Generated by gencpp from file liorf/cloud_info.msg
// DO NOT EDIT!


#ifndef LIORF_MESSAGE_CLOUD_INFO_H
#define LIORF_MESSAGE_CLOUD_INFO_H
...
struct cloud_info_
{
  ...
  typedef boost::shared_ptr< ::liorf::cloud_info_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::liorf::cloud_info_<ContainerAllocator> const> ConstPtr;

}; // struct cloud_info_

typedef ::liorf::cloud_info_<std::allocator<void> > cloud_info;

typedef boost::shared_ptr< ::liorf::cloud_info > cloud_infoPtr;
typedef boost::shared_ptr< ::liorf::cloud_info const> cloud_infoConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::liorf::cloud_info_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::liorf::cloud_info_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::liorf::cloud_info_<ContainerAllocator1> & lhs, const ::liorf::cloud_info_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::liorf::cloud_info_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::liorf::cloud_info_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::liorf::cloud_info_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::liorf::cloud_info_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::liorf::cloud_info_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::liorf::cloud_info_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::liorf::cloud_info_<ContainerAllocator> >
{
  ...
  static const char* value(const ::liorf::cloud_info_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xb654dbfca2e5288eULL;
  static const uint64_t static_value2 = 0xff9e25937cb8519eULL;
};

template<class ContainerAllocator>
struct DataType< ::liorf::cloud_info_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::liorf::cloud_info_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# Cloud Info\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::liorf::cloud_info_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::liorf::cloud_info_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::liorf::cloud_info_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // LIORF_MESSAGE_CLOUD_INFO_H
