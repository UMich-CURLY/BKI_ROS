...
if(liorf_CONFIG_INCLUDED)
  return()
endif()
set(liorf_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(liorf_SOURCE_PREFIX /home/josh/dev/catkin_ws/src/liorf)
  set(liorf_DEVEL_PREFIX /home/josh/dev/catkin_ws/devel)
  set(liorf_INSTALL_PREFIX "")
  set(liorf_PREFIX ${liorf_DEVEL_PREFIX})
else()
  set(liorf_SOURCE_PREFIX "")
  set(liorf_DEVEL_PREFIX "")
  set(liorf_INSTALL_PREFIX /home/josh/dev/catkin_ws/install)
  set(liorf_PREFIX ${liorf_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'liorf' is deprecated")
...
set(liorf_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/josh/dev/catkin_ws/devel/include;/home/josh/dev/catkin_ws/src/liorf/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu " STREQUAL " ")
  set(liorf_INCLUDE_DIRS "")
  set(_include_dirs "/home/josh/dev/catkin_ws/devel/include;/home/josh/dev/catkin_ws/src/liorf/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${liorf_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'liorf' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'liorf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/josh/dev/catkin_ws/src/liorf/${idir}'.  ${_report}")
    endif()
    _list_append_unique(liorf_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND liorf_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND liorf_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT liorf_NUM_DUMMY_TARGETS)
      set(liorf_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::liorf::wrapped-linker-option${liorf_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR liorf_NUM_DUMMY_TARGETS "${liorf_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::liorf::wrapped-linker-option${liorf_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND liorf_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(liorf_LIBRARY_DIRS ${lib_path})
      list(APPEND liorf_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'liorf'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND liorf_LIBRARIES ${lib})
    endif()
  endif()
...
set(liorf_EXPORTED_TARGETS "liorf_generate_messages_cpp;liorf_generate_messages_eus;liorf_generate_messages_lisp;liorf_generate_messages_nodejs;liorf_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${liorf_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 liorf_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${liorf_dep}_FOUND)
      find_package(${liorf_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${liorf_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(liorf_INCLUDE_DIRS ${${liorf_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(liorf_LIBRARIES ${liorf_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${liorf_dep}_LIBRARIES})
  _list_append_deduplicate(liorf_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(liorf_LIBRARIES ${liorf_LIBRARIES})

  _list_append_unique(liorf_LIBRARY_DIRS ${${liorf_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(liorf_EXPORTED_TARGETS ${${liorf_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "liorf-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${liorf_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
