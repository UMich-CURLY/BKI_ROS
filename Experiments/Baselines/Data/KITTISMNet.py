...
class KITTIDataset(Dataset):
    ...
    def __init__(self, directory, eval_param,
        ...
        if self.transfer:
            feat_dir = os.path.join(self._directory, 'SMNetInput_Transfer')
        else:
            feat_dir = os.path.join(self._directory, 'SMNetInput')
        ...
        self.total_len = len(os.listdir(velodyne_dir))
    ...
    def __getitem__(self, idx):
        ...
        for i in idx_range:
            ...
            t_i += 1
        return current_horizon, relative_poses, all_features
